...
java -Xms3072m -Xmx4096m -jar ${JAR} -w 30000.0 -h 30000.0 -n 9 &> rcs-area-30.9.csv

echo "Running test for area of 40km x 40km with 16 nodes"
java -Xms3072m -Xmx4096m -jar ${JAR} -w 40000.0 -h 40000.0 -n 16 &> rcs-area-40.16.csv

echo "Running test for area of 50km x 50km with 25 nodes"
java -Xms3072m -Xmx4096m -jar ${JAR} -w 50000.0 -h 50000.0 -n 25 &> rcs-area-50.25.csv

echo "Running test for area of 60km x 60km with 36 nodes"
java -Xms3072m -Xmx4096m -jar ${JAR} -w 60000.0 -h 60000.0 -n 36 &> rcs-area-60.36.csv

echo "Running test for area of 70km x 70km with 49 nodes"
java -Xms3072m -Xmx4096m -jar ${JAR} -w 70000.0 -h 70000.0 -n 49 &> rcs-area-70.49.csv
